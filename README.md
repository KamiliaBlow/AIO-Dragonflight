...
Tested on: 10.2.7, 11.2.7, 12.0.0, 12.0.5, 12.1.0 and should work on other patches (but not for sure, as Blizzard might break something again). Tested with Lua 5.1 and 5.2.
